...
function IndividualHome() {
  ...
  useEffect(() => {
    ...
    // Manejar scroll para la animación del fondo
    const handleScroll = () => {
      setScrollY(window.scrollY);
      
      // Animar el background
      if (backgroundRef.current) {
        // Ajustar valores basados en el tamaño de pantalla
  ...
  }, [isMobile, isTablet, isSmallMobile]); // Agregamos las variables de media query como dependencias
